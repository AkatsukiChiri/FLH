...
def hadamard_transform(x, scale=1.0):
    """
    Simple implementation of Fast Hadamard Transform for power-of-2 sized last dimension.
    
    Args:
        x: Input tensor with last dimension being a power of 2
        scale: Scaling factor to apply after transform
    ...
    # Reshape to process last dimension
    orig_shape = x.shape
    x = x.reshape(-1, n)
    
    # Iterative Hadamard transform (Cooley-Tukey style)
    h = 1
    while h < n:
